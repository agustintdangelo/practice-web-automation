...
public class GetQuotePage extends AbstractPage {
    ...
    @FindBy(xpath = "//div[@class=' css-12q0e1x-control']")
    private ExtendedWebElement heightDropdown;
    ...
    @FindBy(xpath = "//input[@type='text' and @arialabel='weight']")
    ...
    private List<ExtendedWebElement> noButton;
    ...
    @FindBy(xpath = "//div[@class='CheckBox_box__1WEJ9 false ']")
    private ExtendedWebElement checkAuthorization;
    ...
    @FindBy(xpath = "//div[@class='HideComponentContainer_label__1ZX7o']")
    private ExtendedWebElement yearsCoverage;
    ...
    @FindBy(xpath = "(//div[@class=' css-12q0e1x-control']//div[@Class=' css-gg2x63'])")
    ...
    private ExtendedWebElement incomeSecondOption;

    @FindBy(xpath = "//div[@id='react-select-5-option-12']")
    private ExtendedWebElement heightOption;

    @FindBy(xpath = "//div[@id='react-select-13-option-3']")
    private ExtendedWebElement grandParentOption;

    @FindBy(xpath = "//div[@id='react-select-13-option-4']")
    private ExtendedWebElement otherOption;
...
//        System.out.println(annualHouseholdAndHeightDropdown.isClickable());
        new WebDriverWait(driver, 7).until(ExpectedConditions.visibilityOf(annualHouseholdAndHeightDropdown.getElement()));
        annualHouseholdAndHeightDropdown.click();
        incomeSecondOption.click();
...
//        System.out.println(heightDropdown.isClickable());
        new WebDriverWait(driver, 7).until(ExpectedConditions.visibilityOf(heightDropdown.getElement()));
...
//        select.sendKeys(Keys.chord(Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.DOWN, Keys.ENTER)).perform();
    ...
    public void agreeAuthorization() {
    ...
    public void moveYearCoverageRange(int range) {
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(yearsCoverageRange.getElement()));
//        WebDriverWait firstResult = new WebDriverWait(driver, 35);
//        firstResult.until(driver -> driver.findElement(By.xpath("(//div[@class='SelectRange_track__3BNBE'])[2]")));
        Actions move = new Actions(driver);
    ...
    public String getPreApprovedMessage() {
        new WebDriverWait(driver, 8).until(ExpectedConditions.visibilityOf(recommendedOptionMessage.getElement()));
        return recommendedOptionMessage.getText();
    }
...
//        new WebDriverWait(driver, 20).until(ExpectedConditions.visibilityOf(relationshipDropdown1.getElement()));
        new WebDriverWait(driver, 20).until(ExpectedConditions.visibilityOf(relationshipDropdown1.getElement()));
...
//       System.out.println(relationshipDropdown2.isPresent());
    }

    public void selectRelationshipDropdown2() {
        new WebDriverWait(driver, 20).until(ExpectedConditions.visibilityOf(relationshipDropdown2.getElement()));
        Actions select = new Actions(driver);
        relationshipDropdown2.click();
//       grandParentOption.click();
    ...
    public void waitYearCoverageRangePage() {
        WebDriverWait firstResult = new WebDriverWait(driver, 30);
        firstResult.until(driver -> driver.findElement(By.xpath("(//div[@class='SelectRange_track__3BNBE'])[2]")));
    }
}
